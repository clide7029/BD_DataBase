    ...
    createDatabase: function() {
        ...
        var db = new sqlite3.Database('database.db', (err) => {
            ...
            db.serialize(function() {
                ...
                db.run('create table Portfolio(username TEXT,ticker TEXT,numshares int,PRIMARY KEY (username,ticker),FOREIGN key (username) REFERENCES User,FOREIGN key (ticker) REFERENCES Ticker)');
